    ...
    public class BudgetData
    {
        ...
        public void CreatePremadeComparisons()
        {
            ...
            PreMadeComparsionResults = new List<string>()
            {
                ...
                "The bill for a new Law Enforcement Records Management System is equivalent to 8 times the County's funding for Employment and Training programs that serve at-risk youth and farmworkers.",
                ...
                "The bill for a new Law Enforcement Records Management System is more than a third of the total funding of the Public Defender's Office. The Public Defender provides legal representation for individuals who cannot afford a private attorney.",
                "The cost of a single Armored Medical Vehicle is equivalent to over 6% of the total funding for the Public Defender's Office. The Public Defender provides legal representation for individuals who cannot afford a private attorney.",
